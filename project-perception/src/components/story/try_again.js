...
import JourneyCardsContainer from "../../containers/journeycards";
    ...
    return(
        <div>
            ...
            <div className="ending-container">
                <button className="ending-btn" onClick={handleClick}>{buttonText}</button>
            ...
            {/* <div>
                <JourneyCardsContainer className={className} />
            </div> */}
        </div>
    );
}