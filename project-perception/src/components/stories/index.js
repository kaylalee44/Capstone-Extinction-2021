...
function AnimalDetails(props) {
    ...
    const [hidden, setHidden] = useState(""); //TODO: need to fix with the story cards since when the back to stories button is clicked the cards don't show up again
    const toggleDetails = () => {
    ...
    return (
        <div className={"animal-details " + hidden}>
            <BackToStories toggleDetails={toggleDetails}/>
            ...
            <div className="details-desc">
                <p><strong>Species:</strong> Leatherback Sea Turtle</p>
                <p><strong>Scientific Name:</strong> Dermochelys coriacea</p>
                <p><strong>Ecosystem:</strong> Oceans</p>
            </div>
            <div className="details-status">
                <p><strong>Status:</strong></p>
                <svg className="down-arrow" width="22" height="12" viewBox="0 0 22 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function BackToStories(props) {
    ...
    return (
        <div className="back-to-stories" onClick={toggleDetails}>
