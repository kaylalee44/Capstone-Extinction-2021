            ...
            <div className="story-container">
                ...
                <div className="story-content jellyfish">
                    ...
                    <div className="choice-container">
                        <Link to="/story-rabbit-2" className="choice-btn caribou-btn">Start a journey to find a different source of food.</Link>
                        <Link to="/story-rabbit-1-2" className="choice-btn caribou-btn">Wait for rain to come and revive this sagebrush.</Link>
                    </div>
                </div>
            </div> 
